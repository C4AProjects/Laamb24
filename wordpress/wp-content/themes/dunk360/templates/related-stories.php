...
?>
					...
					<div class="post-news-item lft">
						<div class="post-thumbnail">
							<a href="<?php the_permalink(); ?>
								">
								<?php locate_template( array( '/templates/thumb.php'), true, false ); ?></a>
						</div>
						<div class="post-details">
							<h3 class="entry-title">
								<a href="<?php the_permalink(); ?>
									" title="
									<?php printf( esc_attr__( 'Permalink to %s', 'dunk360' ), the_title_attribute( 'echo=0' ) ); ?>
									" rel="bookmark">
									<?php 	echo short_content($post->post_title, '...', 3); ?></a>
							</h3>
							<h4>
								<?php
		...
		<div>
			<p>
				<?php _e('You do not have any related posts to display.','kava'); ?></p>
		</div>
		<?php endif; ?></div>
</div>